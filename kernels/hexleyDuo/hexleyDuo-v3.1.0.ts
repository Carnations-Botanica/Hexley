...
import {
  ...
  generateRandomHex,
  generateBuildDate,
  getRandomThreadCount,
  getElapsedTime,
  getSystemUptime,
  getKernelBuildString,
  printCopyright,
...
export const Hexley = {
  ...
  database: {} as { [key: string]: any }, // Create the database interface
...
Hexley.databaseMode =
  process.env.DATABASE_MODE === "Sequelizer" ||
...
Hexley.privateFrameworksRootPath = path.join(
  Hexley.frameworksRootPath,
  "PrivateFrameworks/",
);
Hexley.publicFrameworksRootPath = path.join(
  Hexley.frameworksRootPath,
  "PublicFrameworks/",
);
...
if (Hexley.debugMode && Hexley.wantDebug) {
  ...
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.timeSinceBoot is: ${Hexley.timeSinceBoot}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.cpuThreadPanic is: ${Hexley.cpuThreadPanic}`,
  );
  ...
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.kernelsRootPath is: ${Hexley.kernelsRootPath}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.frameworksRootPath is: ${Hexley.frameworksRootPath}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.privateFrameworksRootPath is: ${Hexley.privateFrameworksRootPath}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.publicFrameworksRootPath is: ${Hexley.publicFrameworksRootPath}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.modulesRootPath is: ${Hexley.modulesRootPath}`,
  );
  Hexley.log(
    `[hexleyCore/Dbg] Hexley.driversRootPath is: ${Hexley.driversRootPath}`,
  );
}
...
if (Hexley.resources.framework.event!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Event framework...`,
  );
  const { eventFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "eventFramework/eventFramework.ts",
    )
  );
  ...
  if (Hexley.resources.framework.event!.isLoaded && Hexley.wantDebug) {
    ...
    Hexley.log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)} Simulating a kernel event...`,
    );
    ...
    const listenerPromise = Hexley.frameworks.event.waitForEmit(
    ...
    await listenerPromise.then(
      ([uuid, uptime, status]: [string, string, boolean]) => {
        const color = Hexley.frameworks.aurora.tintGray;
        Hexley.log(
          `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", color)} Success: Event 'kernel.simulated.test' received!`,
        );
        Hexley.log(
          `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", color)}   -> UUID: ${uuid as any}`,
        );
        Hexley.log(
          `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", color)}   -> Uptime: ${uptime as any} nanoseconds`,
        );
        Hexley.log(
          `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", color)}   -> Status: ${status as any}`,
        );
      },
    );
    ...
    Hexley.log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)} Emitting an event with no previously registered listeners...`,
    );
    Hexley.frameworks.event.emit("kernel.unhandled.test", "data");
  } else {
    Hexley.log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintRed)} Event Framework not loaded. Skipping simulation.`,
    );
  }
} else {
  // If the real framework is disabled, we still mark the status as loaded since the core EventEmitter is always available.
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Event support is disabled. Falling back to core EventEmitter.`,
  );
...
if (Hexley.resources.framework.aurora!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Aurora framework...`,
  );
  const { auroraFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "auroraFramework/auroraFramework.ts",
    )
  );
  Hexley.frameworks.aurora = auroraFramework;
  await Hexley.frameworks.aurora.initializeAurora(Hexley);
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore/Test]", Hexley.frameworks.aurora.tintRedBright)} Aurora loaded successfully! Console output is now colorized.`,
  );
} else {
  // Since the actual framework is disabled, we mark the dummy as loaded to not fail on requests.
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Aurora support is disabled. Console output will not be colorized.`,
  );
...
if (Hexley.resources.framework.filesystem!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Filesystem framework...`,
  );
  const { filesystemFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "filesystemFramework/filesystemFramework.ts",
    )
  );
  ...
  if (Hexley.debugMode && Hexley.wantDebug && Hexley.databaseMode === "Local") {
    Hexley.databaseLocalDir = path.join(
      Hexley.filesystemRootDir,
      "var",
      "db.json",
    );
    Hexley.log(
      `[hexleyCore/Dbg] Hexley.databaseLocalDir is: ${Hexley.databaseLocalDir}`,
    );
  }
  ...
  if (
    Hexley.debugMode &&
    Hexley.resources.framework.filesystem?.isLoaded &&
    Hexley.wantDebug
  ) {
    log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)} === Filesystem Debug Dump ===`,
    );
    log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)}   - Root Directory: ${Hexley.filesystemRootDir}`,
    );
    log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)}   - User Directory: ${Hexley.filesystemUserDir}`,
    );
    log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)}   - VFS Environment Current Path: ${Hexley.filesystemCWDir}`,
    );
    ...
    log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore/Dbg]", Hexley.frameworks.aurora.tintGray)} === Filesystem Info Dumped! ===`,
    );
  }
} else {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Filesystem support is disabled. System will run in memory only.`,
  );
}
...
if (Hexley.resources.framework.database!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Database framework...`,
  );

  // Check if the filesystem has loaded (required to know where the local database file is)
  if (!Hexley.resources.framework.filesystem!.isLoaded) {
    Hexley.log(
      `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintRed)} ERROR: Cannot load Database Framework. Filesystem is not ready.`,
    );
  } else {
    const { databaseFramework } = await import(
      path.join(
        Hexley.privateFrameworksRootPath,
        "databaseFramework/databaseFramework.ts",
      )
    );
  ...
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Database support is disabled. Modules and Frameworks requiring database access may not work correctly.`,
  );
}
...
if (Hexley.resources.framework.version!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Version framework...`,
  );
  const { versionFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "versionFramework/versionFramework.ts",
    )
  );
  ...
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Version support is disabled. Version tracking will be unavailable.`,
  );
}
...
if (Hexley.resources.framework.registry!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading The Registry...`,
  );
  const { registryFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "registryFramework/registryFramework.ts",
    )
  );
  Hexley.frameworks.registry = registryFramework;
  await Hexley.frameworks.registry.initializeRegistry(Hexley);
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore/registration]", Hexley.frameworks.aurora.tintGray)} Beginning sequential registration of core components...`,
  );
  const registry = Hexley.frameworks.registry;
  await registry.addEntryByPlist(
    Hexley,
    path.join(Hexley.kernelsRootPath, "hexleyDuo", "info.plist"),
  );
  await registry.addEntryByPlist(
    Hexley,
    path.join(Hexley.privateFrameworksRootPath, "eventFramework", "info.plist"),
  );
  ...
  if (Hexley.resources.framework.database!.isLoaded) {
    const mode = (
      Hexley.resources.framework.database as databaseFrameworkStatus
    ).selectedMode;
  ...
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore/registration]", Hexley.frameworks.aurora.tintGray)} Core component registration complete.`,
  );
} else {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} The Registery is disabled. This can be considered a critical error, if issues arise later, this was the cause.`,
  );
}
...
if (Hexley.resources.framework.loader!.wantLoad) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loading Loader framework...`,
  );
  const { loaderFramework } = await import(
    path.join(
      Hexley.privateFrameworksRootPath,
      "loaderFramework/loaderFramework.ts",
    )
  );
  ...
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Loader support is disabled. No 3rd party frameworks or modules will be loaded.`,
  );
}
...
Hexley.log(
  `${Hexley.frameworks.aurora.colorText(`[hexleyCore]`, Hexley.frameworks.aurora.tintGray)} There ${verb} ${Hexley.frameworks.aurora.colorText(`${moduleCount}`, `#B5FF70`)} ${moduleWord}, ${Hexley.frameworks.aurora.colorText(`${frameworkCount}`, `#B5FF70`)} ${frameworkWord}, ${Hexley.frameworks.aurora.colorText(`${driverCount}`, `#B5FF70`)} ${driverWord}, and ${Hexley.frameworks.aurora.colorText(`${kernelCount}`, `#B5FF70`)} ${kernelWord} in the registry, for a total of ${Hexley.frameworks.aurora.colorText(`${totalCount}`, `#B5FF70`)} ${entryWord}.`,
);
Hexley.log(
  `${Hexley.frameworks.aurora.colorText("[hexleyCore]", Hexley.frameworks.aurora.tintGray)} Bootstrapping process complete.`,
);

// Conditionally drop into hexShell
if (
  Hexley.resources.framework.hexShell?.isLoaded &&
  process.env.HEXSHELL_ENABLED === "TRUE"
) {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText(`[hexleyCore]`, Hexley.frameworks.aurora.tintGray)} hexShell will now be loaded.`,
  );
  const modulePlistPath = path.join(
    Hexley.modulesRootPath,
    "hexShell",
    "info.plist",
  );
  await Hexley.frameworks.registry.addEntryByPlist(Hexley, modulePlistPath);
  const { hexShell } = await import(
    path.join(Hexley.modulesRootPath, "hexShell/hexShell.ts")
  );
  hexShell.hexShellInit(Hexley);
} else {
  Hexley.log(
    `${Hexley.frameworks.aurora.colorText(`[hexleyCore]`, Hexley.frameworks.aurora.tintGray)} hexShell Framework was not loaded, system will run without user shell.`,
  );
}
